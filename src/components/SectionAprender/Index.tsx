        ...
        <section className=" bg-gradient-to-b from-[#2a2f78] to-sky-500">
            <div className='w-full max-w-[1400px] m-auto px-5 md:px-[5%] flex flex-col items-center text-white '>
                ...
                <div className='flex flex-col gap-10'>
                    <div className="flex items-center gap-3 shadow-lg bg-[#d6e3f2] rounded-2xl p-5 text-black">
                    ...
                    <div className="flex items-center gap-3 shadow-lg bg-[#d6e3f2] rounded-2xl p-5 mb-5 text-black">
