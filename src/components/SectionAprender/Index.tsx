...
export default function SectionAprender(){
    return (
        <section className="w-full max-w-[1400px] m-auto px-5 md:px-[5%] flex flex-col items-center text-white">
            <div>
                <h1 className='text-4xl md:text-5xl text-center font-bold text-gradient mb-5 '>
                    Alguns dos temas que serão abordados nessa MasterClass são:
                </h1>
            </div>

            <div className='flex flex-col gap-5'>
                <div className="flex items-center gap-3 bg-[#d6e3f2] rounded-2xl p-5 text-black">
                ...
                <div className="flex items-center gap-3 bg-[#d6e3f2] rounded-2xl p-5 mb-5 text-black">
