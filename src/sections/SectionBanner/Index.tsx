...
export default function Section1() {
    return(
        <section className="w-full pt-[60px] md:px-[5%] bg-gradient-to-b lg:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#2a2f78]   to-sky-500 md:to-70%">
            <div className='flex flex-col lg:flex-row items-center md:justify-center '>
                ...
                <div className='w-full px-5 md:px-0 flex flex-col items-center  md:w-[60%] max-w-[600px] md:justify-center'data-aos="fade-up-left" data-aos-duration="1500">
